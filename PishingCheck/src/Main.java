...
public class Main {
    private static final String KEYWORDS_FILE = "C:\\repos\\pishing\\PishingCheck\\src\\phishing.txt";
    private static final String MESSAGE_FILE = "C:\\repos\\pishing\\PishingCheck\\src\\informacion.txt";
